            ...
            <section className="main-content-display-container content-box">
                <section className="main-content-display-container content-padding">
                    ...
                    <a href="https://citysearch.vercel.app/" target="_blank" rel="noopener" className="gif-container">
                        <img src="https://user-images.githubusercontent.com/110955503/221709782-410bec18-7a3c-44c3-9011-dc6ecf483471.gif" className="content-image"/>
                    </a>
                    ...
                    <a href="https://spoiled-fruit.vercel.app/" target="_blank" rel="noopener" className="gif-container">
                        <img src="https://media.giphy.com/media/A1UYoA8az68IQQ0SQO/giphy.gif" className="content-image"/>
                    </a>
                    ...
                    <a href="https://grant-guru-fe.vercel.app/" target="_blank" rel="noopener" className="gif-container">
                        <img src="https://user-images.githubusercontent.com/111818942/230463892-75b499d4-e3a6-475a-b9df-89940440fc3e.gif" className="content-image"/>
                    </a>
